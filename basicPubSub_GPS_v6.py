...
def GPSReader(line):
		...
		message['aa_NEW_location'] = LocaFormat(data.lat) + "," + LocaFormat(data.lon)
...
# geofence
zone1 = [(41.910979,-87.643464),(41.911362,-87.624839),(41.897691,-87.624238),(41.897819,-87.642777)]
zone2 = [(41.886894,-87.637027),(41.876222,-87.636941),(41.876030,-87.622350),(41.888874,-87.622865)]
...
while True:
    ...
    if args.mode == 'both' or args.mode == 'publish':
		...
		''' 
		# GeoFence
		message['3_geo'] = GeoFence(message['2location'], zone)
		message['4_geo'] = GeoFence(message['2location'], zone1)
		message['5_geo'] = GeoFence(message['2location'], zone2)
		'''
